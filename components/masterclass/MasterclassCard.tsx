...
export const MasterclassCard: React.FC<MasterclassCardProps> = ({ masterclass }) => {
    ...
    return (
      <Card variant="default" className="overflow-hidden h-full">
        ...
        <div className="p-5 space-y-2">
          <h3 className="text-base font-semibold text-gray-900">{masterclass.title}</h3>
  ...
  const cardContent = (
    <Card variant="interactive" className="overflow-hidden h-full card-hover group">
      <div
        className="aspect-video bg-gray-100 flex items-center justify-center relative image-zoom-hover cursor-pointer"
  ...
  // If no videoId, wrap in Link as before; if videoId, no Link (clicking plays inline)
  if (videoId) {
